...
/*   Updated: 2018/03/06 10:10:22 by fpasquer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int				Captures::checkCaptures(unsigned int const y_tmp, unsigned int const x_tmp, short const val, char *ways)
{
	char					tmp;
	unsigned int			i;
	unsigned int			count;
